...
if(isset($_POST['ins'])){
  ...
  $basic=$_POST['basic'];
  $result1=mysqli_query($conn,"INSERT INTO employee(ename,eid,designation,dob,phone_no,basic) VALUES('$ename','$eid','$designation','$dob','$phn','$basic')");
}
...
if(isset($_POST['upd'])){
  ...
  $designation=$_POST['designation'];
  $basic=$_POST['basic'];
  $result2=mysqli_query($conn,"UPDATE employee SET ename='$ename',eid='$eid',designation='$designation',dob='$dob',phone_no='$phn',basic= '$basic' WHERE eid='$eid';");
...
<div id="overlayiform" class="container-fluid" style="display:none;">
  <form id="form" action="" class="p-5 mt-3" method="post">
    ...
    <div class="text-center">
      <input type="submit" class="btn btn-primary" name="ins" value="Insert">
